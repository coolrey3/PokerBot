...
#UTG Open Check
    if message.content.find("!UTG") !=-1:
        ...
        if holecards in utgOpen:
            await message.channel.send(holecards + ' Under the Gun, GTO says open')
        else:
            await message.channel.send(holecards + " Under the Gun, GTO says Fold it")
...
#MP Open Check
    if message.content.find("!MP") !=-1:
        ...
        if holecards in mpOpen:
            await message.channel.send(holecards + ' in MP, GTO says open')
        else:
            await message.channel.send(holecards + " in MP, GTO says Fold it")
...
#CO Open Check
    if message.content.find("!CO") !=-1:
        ...
        if holecards in coOpen:
            await message.channel.send(holecards + ' in the CO, GTO says open')
        else:
            await message.channel.send(holecards + " in the CO, GTO says Fold it")
...
#SB Open Check
    if message.content.find("!SB") !=-1:
        ...
        if holecards in sbOpen:
            await message.channel.send(holecards + ' in the SB, GTO says open')
        else:
            await message.channel.send(holecards + " in the SB, GTO says Fold it")
...
#Button Open Check
    if message.content.find("!Button") !=-1:
        ...
        if holecards in buttonOpen:
            await message.channel.send(holecards + ' on the Button, GTO says open')

        else:
            await message.channel.send(holecards + " on the Button, GTO says Fold it")
    elif message.content.find("!BTN") != -1 or message.content.find("!btn") != -1:
        holecards = message.content[5:]
        print(holecards)
        if holecards in buttonOpen:
            await message.channel.send(holecards + ' on the Button, GTO says open')
